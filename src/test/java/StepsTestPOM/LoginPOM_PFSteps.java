...
import PageFactory.HomePagePOM_PF;
import PageFactory.LoginPagePOM_PF;
...
public class LoginPOM_PFSteps {
    private static  WebDriver driver=null;
    private static LoginPagePOM_PF loginObject;
    private static HomePagePOM_PF homePageObject;

    @Before
    public void driverInitialization()
    { WebDriverManager.chromedriver().setup();
       driver = new ChromeDriver();
       homePageObject=new HomePagePOM_PF(driver);
       loginObject=new LoginPagePOM_PF(driver);
    }
